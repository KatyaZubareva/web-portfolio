...
> Вы можете найти все изображения в папке [`screenshots`](https://github.com/KatyaZubareva/web-portfolio/tree/main/screenshots) репозитория, соответствующие примерам GET и POST запросов через CLI и GUI-инструменты.
